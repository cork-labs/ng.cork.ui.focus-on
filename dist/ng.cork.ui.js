/**
 * ng.cork.ui.focus-on - v0.0.4 - 2015-04-08
...
(function (angular) {
    ...
    var module = angular.module('ng.cork.ui.focus-on.enter-click', []);

    /**
     * @ngdoc directive
     * @name ng.cork.ui.focus-on.enter-click.corkUiEnterClick
     *
     * @description
...
(function (angular) {
    ...
    var module = angular.module('ng.cork.ui.focus-on.stop-propagation', []);

    /**
     * @ngdoc directive
     * @name ng.cork.ui.focus-on.stop-propagation.corkUiStopPropagation
     *
     * @description
...
(function (angular) {
    ...
    var module = angular.module('ng.cork.ui.focus-on.textarea-auto-resize', []);

    /**
     * @ngdoc directive
     * @name ng.cork.ui.focus-on.textarea-auto-resize.corkUiTextareaAutoResize
     *
     * @description
...
(function (angular) {
    ...
    var module = angular.module('ng.cork.ui.focus-on', [
        'ng.cork.ui.focus-on.enter-click',
        'ng.cork.ui.focus-on',
        'ng.cork.ui.focus-on.stop-propagation'
    ]);
